            ...
            <RadioGroup onChange={handleChange} value={mode}>
                <Stack direction='column'>
                    <div className="mb-4 hidden lg:flex flex-col bg-[#F3F3F0] dark:bg-[#282A33] rounded-[12px]">
                        <div className='p-4'><Radio value='qtum'><span className='font-semibold text-sm'>Pay with QTUM</span></Radio></div>
                        <Divider />
                        <div className='p-4'><Radio value='wallet'><span className='font-semibold text-sm'>Pay with wallet</span></Radio></div>
                    </div>

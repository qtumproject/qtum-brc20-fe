...
export default function FeeType({ title, type = 'solid', setValue, amount, focus, onClick }: IProps) {
    return <>
        <div className={`hidden lg:flex flex-col items-center border-2 rounded-[12px] border-[#e7e7e1] px-6 py-2 cursor-pointer w-[218px] h-[79px] ${focus ? 'border-black' : 'border-[#e7e7e1]'} `} onClick={onClick}>
